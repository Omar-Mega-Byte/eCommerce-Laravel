...
<body class="bg-gray-100">
    ...
    <div id="sidebar" class="fixed border-white border-4 top-0 right-0 h-full w-64 bg-gradient-to-l from-blue-600 to-blue-500 text-white p-6 transform translate-x-full transition-transform duration-300 ease-in-out shadow-lg rounded-l-lg z-50">
    ...
    <button id="sidebarToggle" class="fixed border-white border-2 top-4 right-4 bg-gradient-to-r from-blue-600 to-blue-500 text-white p-3 rounded-full shadow-md focus:outline-none transition-transform duration-300 ease-in-out" style="z-index: 9999;">
        <!-- Font Awesome icon -->
