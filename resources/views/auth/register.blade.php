...
<div class="w-full max-w-md mx-auto mt-10">
    ...
    <form x-data="formSubmit" @submit.prevent="submit" method="post" action="{{ route('register') }}" class=" bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4">
        @csrf
        <div class="mb-6">
            <label class="block text-white text-sm font-thin  mb-2" for="name">
                Name
            </label>
        ...
        <div class="mb-6">
            <label class="block text-white text-sm font-thin mb-2" for="email">
                Email
            </label>
        ...
        <div class="mb-6">
            <label class="block text-white text-sm font-thin mb-2" for="password">
                Password
            </label>
        ...
        <div class="mb-6">
            <label class="block text-white text-sm font-thin mb-2" for="password_confirmation">
                Confirm Password
            </label>
        ...
        <div class="block text-white text-sm font-thin mb-4">
