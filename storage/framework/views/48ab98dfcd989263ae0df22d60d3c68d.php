...
<div class="w-full max-w-md mx-auto mt-10">
    <form method="post" action="<?php echo e(route('register')); ?>" class="bg-gradient-to-r from-green-400 to-blue-500 shadow-lg rounded-lg px-8 pt-6 pb-8 mb-4">
        <?php echo csrf_field(); ?>
        <div class="mb-6">
            <label class="block text-white text-sm font-bold mb-2" for="name">
                Name
            </label>
            <input id="name" type="text" name="name" value="<?php echo e(old('name')); ?>" autofocus class="shadow appearance-none border rounded w-full py-3 px-4 text-gray-900 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-600">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-6">
            ...
            <input id="email" type="text" name="email" value="<?php echo e(old('email')); ?>" class="shadow appearance-none border rounded w-full py-3 px-4 text-gray-900 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-600">
