...
<div class="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-16 text-center">
        <h1 class="text-5xl font-extrabold text-blue-800 mb-6">About Our eCommerce Store</h1>
...
<div class="flex flex-col md:flex-row items-center justify-between bg-white p-10 rounded-xl shadow-xl mb-12 transform transition hover:scale-105">
    ...
    <div class="bg-white p-10 rounded-xl shadow-xl mb-12">
        <h2 class="text-4xl font-semibold font-mono text-gray-900 mb-8 text-center">Meet Our Team</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            <div class="text-center transform transition hover:scale-105">
                ...
                <h3 class="text-2xl font-semibold mb-2">عادل شكل</h3>
                <p class="text-gray-700 font-oswald">Founder & CEO</p>
            </div>
            <div class="text-center transform transition hover:scale-105">
                <img src="/storage/images/Team 3.gif" alt="Team Member 2" class="rounded-full w-28 mx-auto mb-4 shadow-lg">
                <h3 class="text-2xl font-semibold mb-2">السيسي</h3>
                <p class="text-gray-700 font-oswald">Head of Operations</p>
            </div>
            <div class="text-center transform transition hover:scale-105">
                <img src="/storage/images/Team 2.gif" alt="Team Member 3" class="rounded-full w-28 mx-auto mb-4 shadow-lg">
                <h3 class="text-2xl font-semibold mb-2">حمثلاح</h3>
                <p class="text-gray-700 font-oswald">Marketing Manager</p>
            </div>
        </div>
    </div>
        ...
        <div class="flex flex-col md:flex-row items-center justify-center">
            <div class="md:w-1/2 md:mr-10 mb-8 md:mb-0">
                ...
                <ul class="list-disc pl-5 text-gray-700">
                    ...
                    <li><a class="text-blue-500 hover:underline" href="<?php echo e(route('contact')); ?>">Contact us</a></li>
                </ul>
            </div>
            <div class="md:w-1/2">
